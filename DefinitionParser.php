...
class Parser
{
    ...
    protected function parse_map(Input $input)
    {
        ...
        if (!$failed_map_1) {
            $result = new Success(new Map($parts, $expr));
        }
    ...
    protected function parse_labelParser(Input $input)
    {
        ...
        if (!$failed_map_3) {
            ...
            $result = $this->parse_notPredicate($input);
    ...
    protected function parse_sequences(Input $input)
    {
        ...
        if (!$failed_map_5) {
            $result = new Success(array_reduce($rest, function ($left, $right) {
    ...
    protected function parse_notPredicate(Input $input)
    {
