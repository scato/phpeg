...
class ParserFactory
{
    ...
    public function createParser()
    {
        ...
        $grammar->addRule('Import',              $this->grammarRuleFactory->createImport($grammar));
        $grammar->addRule('Namespace',           $this->grammarRuleFactory->createNamespace($grammar));
        $grammar->addRule('QualifiedIdentifier', $this->grammarRuleFactory->createQualifiedIdentifier($grammar));
